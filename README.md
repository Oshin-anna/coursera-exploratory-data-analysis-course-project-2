...
For each year and each type of PM source, the NEI records how many tons of PM2.5 were emitted from that source over the entire year. The data we  will use for this assignment are from the years 1999, 2002, 2005, and 2008.
